 ...
 */
void count_alive(int ***grid, int **new_grid, int size, int cells_group, int threads_num) {

    /* Create only once the threads you will be using, to avoid 
        continuous fork and joins. */
